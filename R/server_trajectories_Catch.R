...
.traj_Catch_server <- function(input, output, session, traj_df) { 
  ...
  observeEvent(input$traj_Catch_scenarios, {
    if (!setequal(input$traj_Catch_scenarios, traj_Catch_values$scenarios_current)) {
  ...
  observeEvent(input$confirm_button, {
    ...
    if (input$navmenu == "tab_trajectories" && input$trajectories_tabs == "tab_traj_Catch") {
      ...
      traj_Catch_values$x_min_current = input$traj_Catch_x_min
      traj_Catch_values$x_max_current = input$traj_Catch_x_max
      traj_Catch_values$y_min_current = input$traj_Catch_y_min
      traj_Catch_values$y_max_current = input$traj_Catch_y_max
      ...
      x_lim_min_traj_Catch(input$traj_Catch_x_min)
      x_lim_max_traj_Catch(input$traj_Catch_x_max)
