#' @keywords internal
.traj_FFmsy_server <- function(input, output, session, traj_df) { 
  ...
  observeEvent(input$confirm_button, {
    ...
    if (input$navmenu == "tab_trajectories" && input$trajectories_tabs == "tab_traj_FFmsy") {
      ...
      traj_FFmsy_values$x_min_current = input$traj_FFmsy_x_min
      traj_FFmsy_values$x_max_current = input$traj_FFmsy_x_max
      traj_FFmsy_values$y_min_current = input$traj_FFmsy_y_min
      traj_FFmsy_values$y_max_current = input$traj_FFmsy_y_max
      ...
      filtered_traj_FFmsy(
        traj_df %>%
          filter(
            Scenario %in% input$traj_FFmsy_scenarios
          ) %>%
          droplevels()
      )
      ...
      x_lim_min_traj_FFmsy(input$traj_FFmsy_x_min)
      x_lim_max_traj_FFmsy(input$traj_FFmsy_x_max)
      y_lim_min_traj_FFmsy(input$traj_FFmsy_y_min)
      y_lim_max_traj_FFmsy(input$traj_FFmsy_y_max)
    }
  })
