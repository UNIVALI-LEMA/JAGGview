...
.traj_BB0_server <- function(
  ...
  observeEvent(input$traj_BB0_scenarios, {
    if(!setequal(input$traj_BB0_scenarios, traj_BB0_values$scenarios_current)) {
      traj_BB0_change$scenarios_changed = TRUE
    }
    else {
  ...
  observeEvent(input$traj_BB0_title_x, {
    if (!identical(input$traj_BB0_title_x, traj_BB0_values$title_x_current)) {
      traj_BB0_change$title_x_changed = TRUE
    }
    else {
  ...
  observeEvent(input$traj_BB0_title_y, {
    if (!identical(input$traj_BB0_title_y, traj_BB0_values$title_y_current)) {
      traj_BB0_change$title_y_changed = TRUE
    }
    else {
      traj_BB0_change$title_y_changed = FALSE
    }
  }, ignoreInit = TRUE)

  observeEvent(input$traj_BB0_color, {
    if (!identical(input$traj_BB0_color, traj_BB0_values$color_current)) {
      traj_BB0_change$color_changed = TRUE
    }
    else {
      traj_BB0_change$color_changed = FALSE
    }
  }, ignoreInit = TRUE)

  observeEvent(input$traj_BB0_x_min, {
    if (!identical(input$traj_BB0_x_min, traj_BB0_values$x_min_current)) {
      traj_BB0_change$x_min_changed = TRUE
    }
    else {
      traj_BB0_change$x_min_changed = FALSE
    }
  }, ignoreInit = TRUE)

  observeEvent(input$traj_BB0_x_max, {
    if (!identical(input$traj_BB0_x_max, traj_BB0_values$x_max_current)) {
      traj_BB0_change$x_max_changed = TRUE
    }
    else {
      traj_BB0_change$x_max_changed = FALSE
    }
  }, ignoreInit = TRUE)

  observeEvent(input$traj_BB0_y_min, {
    if (!identical(input$traj_BB0_y_min, traj_BB0_values$y_min_current)) {
      traj_BB0_change$y_min_changed = TRUE
    }
    else {
      traj_BB0_change$y_min_changed = FALSE
    }
  }, ignoreInit = TRUE)

  observeEvent(input$traj_BB0_y_max, {
    if (!identical(input$traj_BB0_y_max, traj_BB0_values$y_max_current)) {
      traj_BB0_change$y_max_changed = TRUE
    }
    else {
      traj_BB0_change$y_max_changed = FALSE
    }
  }, ignoreInit = TRUE)

  observeEvent(input$traj_BB0_si_suffix, {
    if(!identical(input$traj_BB0_si_suffix, traj_BB0_values$si_suffix_current)){
      traj_BB0_change$si_suffix_changed = TRUE
    }
    else {
      traj_BB0_change$si_suffix_changed = FALSE
    }
  }, ignoreInit = TRUE)
  ...
  observeEvent(input$confirm_button, {
    ...
    if (
      ...
      traj_BB0_values$si_suffix_current = input$traj_BB0_si_suffix
      ...
      si_suffix_traj_BB0(input$traj_BB0_si_suffix)
    }
  }, ignoreInit = TRUE)
    ...
    plots <- map(scenarios, function(s) {
      ...
      plot_ly() %>%
        add_ribbons(
          ...
          text = ~paste0(
            "CI(90): (", 
            .international_system_prefixes(lcl2, si_suffix_traj_BB0()), ") - (", 
            .international_system_prefixes(ucl2, si_suffix_traj_BB0()), ")"
          )
        ) %>%
        add_ribbons(
          data = df,
          ...
          text = ~paste0(
            "CI(97,5): (", 
            .international_system_prefixes(lcl, si_suffix_traj_BB0()), ") - (", 
            .international_system_prefixes(ucl, si_suffix_traj_BB0()), ")"
          )
        ) %>%
        add_lines(
          data = df,
          ...
          hoverinfo = "text+x",
          text = ~paste0(
            "Value: ", .international_system_prefixes(mu, si_suffix_traj_BB0())
          )
        ) %>%
        layout(
          showlegend = FALSE,
