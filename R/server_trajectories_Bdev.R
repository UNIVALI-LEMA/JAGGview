...
.traj_Bdev_server <- function(input, output, session, traj_df) { 
  ...
  observeEvent(input$confirm_button, {
    ...
    if (input$navmenu == "tab_trajectories" && 
      ...
      traj_Bdev_values$x_min_current = input$traj_Bdev_x_min
      traj_Bdev_values$x_max_current = input$traj_Bdev_x_max
      traj_Bdev_values$y_min_current = input$traj_Bdev_y_min
      traj_Bdev_values$y_max_current = input$traj_Bdev_y_max
      ...
      x_lim_min_traj_Bdev(input$traj_Bdev_x_min)
      x_lim_max_traj_Bdev(input$traj_Bdev_x_max)
