...
.retrospective_analysis_FFmsy_server <- function(input, output, session, ra_df){
  ...
  observeEvent(input$confirm_button, {
    ...
    if (input$navmenu == "tab_retrospective_analysis" && 
      ...
      ra_FFmsy_values$x_min_current = input$ra_FFmsy_x_min
      ra_FFmsy_values$x_max_current = input$ra_FFmsy_x_max
      ra_FFmsy_values$y_min_current = input$ra_FFmsy_y_min
      ra_FFmsy_values$y_max_current = input$ra_FFmsy_y_max
      ...
      x_lim_min_ra_FFmsy(input$ra_FFmsy_x_min)
      x_lim_max_ra_FFmsy(input$ra_FFmsy_x_max)
